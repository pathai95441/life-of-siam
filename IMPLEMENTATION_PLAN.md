...
| 3 | ขยายโลก (แผนที่ที่ 2, NPC schedule) | 🔵 กำลังทำ — M1 ✅ M2 ✅ |
...
ชุดเทสต์ปัจจุบัน **458 assertion ผ่านทั้งหมด**
headless: `world_space` 35 · `world_object_data` 73 · `world_body` 20 · `projection` 31 · `entity` 69 · `economy` 26 · `shop` 32 · `shop_ui` 19 · `daily_summary` 12 · `economy_loop` 21 · `map` 14 · `save_format` 19 · `save_disk` 16 · `smoke` 50 · `world` 16
...
| **D18** | **ผู้เล่นถูกเก็บเป็น saveable ต่อแผนที่** — พอ M3 ทำให้สถานะคงอยู่ การกลับเข้าแผนที่เดิมจะคืน**ตำแหน่งเก่า**ทับ spawn ของประตู | **M3 ต้องแยก "โหลดเซฟ" ออกจาก "เดินผ่านประตู"** |
